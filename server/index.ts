...
import sceneBookmarksRouter from './routes/sceneBookmarks.js';
...
app.use('/api/scene-bookmarks', sceneBookmarksRouter);
app.use('/api/activity', activityRouter);
app.use('/api/saved-searches', authenticateToken, savedSearchesRouter);

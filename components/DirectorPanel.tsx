...
const DirectorPanel: React.FC<DirectorPanelProps> = ({ settings, onChange, onAutoSuggest, onClear, disabled }) => {
  ...
  return (
    <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-4 space-y-4 max-h-[300px] overflow-y-auto relative">
      <div className="flex items-center justify-between sticky top-0 bg-zinc-900 z-10 py-2 border-b border-zinc-800 mb-2">
        ...
        <div className="flex items-center gap-2">
          <button 
            onClick={onClear}
            disabled={disabled}
            className="text-[10px] uppercase font-bold tracking-wider bg-red-900/10 hover:bg-red-900/30 text-red-400 border border-red-900/30 hover:border-red-500/50 px-3 py-1.5 rounded transition-all"
          ...
          <button 
            ...
            disabled={disabled}
            className="text-[10px] uppercase font-bold tracking-wider bg-amber-900/20 hover:bg-amber-900/40 text-amber-300 border border-amber-900/50 hover:border-amber-500/50 px-3 py-1.5 rounded transition-all flex items-center gap-1"

      ...
      <div className="bg-black/50 p-3 border-b border-zinc-800 flex justify-between items-center">
        <div className="flex items-center gap-2">
          {scene.is_ai_generated && (
            <span 
              className="text-xs px-2 py-0.5 rounded bg-purple-900/30 text-purple-400 border border-purple-700/50 flex items-center gap-1"
      ...
      <div className="p-5 flex-1 flex flex-col gap-4 relative">
        ...
        <div className="flex-1 min-h-[120px]">
          <h4 className="text-[10px] text-zinc-500 uppercase tracking-widest font-bold mb-2 flex items-center gap-2">
            ...
            {scene.is_ai_generated && (
              <span 
                className="text-[9px] px-1.5 py-0.5 rounded bg-purple-900/30 text-purple-400 border border-purple-700/50 flex items-center gap-1"
                title="AI-Generated Content"
              >
